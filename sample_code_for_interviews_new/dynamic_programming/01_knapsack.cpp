...
int 01_knapsack(vector<int> wts, vector<int> val, int wt_limit, int n){
  ...
  // to choose it or not
    if(wts[n-1]<= wt_limit){
      ...
      val_1 = val;
      val_1,pop_back();
      output_1 = output_1 + 01_knapsack(wt_1, val_1, wt_limit-wt[n-1], n-1);
      int output_2 = 01_knapsack(wt_1, val_1, wt_limit, n-1);
      ...
      val_1 = val;
      val_1,pop_back();
      int output_3 = 01_knapsack(wt_1, val_1, wt_limit, n-1);
      return output_3;
    }
}
